    ...
    <>
      ...
      <div
        ...
        style={{
          left: `${position.x}px`,
          top: `${position.y}px`,
          transform: `translate(-50%, -50%) ${isHovered ? 'scale(1.8)' : isClicked ? 'scale(0.85)' : 'scale(1)'}`,
          backgroundColor: isHovered ? 'rgba(34, 211, 238, 0.15)' : 'transparent', // Cyan translucent bg on hover
